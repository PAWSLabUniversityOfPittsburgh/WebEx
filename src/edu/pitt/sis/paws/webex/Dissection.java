...
public class Dissection extends HttpServlet
{
	...
	public static final String REQ_UM = "um";

	public static final String REQ_UMM = "umm";
...
//			" class='webex_bullet_check'" };
			...
			throws ServletException, IOException
	{
		...
		try
		{
			...
			String sql = "SELECT Code,Comments,LNo FROM Dis where ProgID="
					+ req_activity + " ORDER BY LNo";
